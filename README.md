...
* Statistical Testing & Methodology
   ...
   | :--- | :--- | :--- | :--- |
   | Week 1 vs. Week 2 Usage Drop-off	| Paired T-Test | P=0.9537	| Failed to reject H0. Non-converters stay flat and inactive across both weeks rather than losing steam over time. |
   | High Usage Intensity Drives Conversion	| Mann-Whitney U	| P=0.0036	| Reject H0. Converters log significantly higher session duration (28.0 mins vs 19.3 mins). |
   ...
   | Support Delays Drive Conversion Loss | Mann-Whitney U	| P=0.2416	| Failed to reject H0. Support resolution delays are not significantly higher for non-converters. Ticket creation itself is the friction event. |
   ...
   | Survey Avoidance Correlates with Churn	| Chi-Square (χ^2) | P=0.6400	| Failed to reject H0. Skipping feedback surveys is neutral and does not indicate churn intent. |
